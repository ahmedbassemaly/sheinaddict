            ...
            <div class="row">
                <div class="col-md-10">
                        ...
                        <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                            ...
                            <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                                ...
                                <div> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> </div>
                                    <div class="text-muted">1985 reviews</div> <button type="button" class="btn btn-warning mt-4 text-white"><i class="icon-cart-add mr-2"></i> Edit Product</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-body mt-3">
                        <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                        <img src="<?php echo ImageRoot . 'category/category-2.png' ; ?>" width="150" height="150"></img>
                            <div class="media-body">
                                <h6 class="media-title font-weight-semibold"> <a href="" data-abc="true">NASA Oversized Hoodie</a> </h6>
                                <ul class="list-inline list-inline-dotted mb-3 mb-lg-2">
                                    <li class="list-inline-item"><a href="#" class="text-muted" data-abc="true">Men</a></li>
                                    <li class="list-inline-item"><a href="#" class="text-muted" data-abc="true">Hoodies</a></li>
                                </ul>
                                <h6> Men Hoodie 
                                <ul class="list-inline list-inline-dotted mb-0">
                                    <li class="list-inline-item">Add to <a href="#" data-abc="true">wishlist</a></li>
                            ...
                            <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                                ...
                                <div class="text-muted">2349 reviews</div> <button type="button" class="btn btn-warning mt-4 text-white"><i class="icon-cart-add mr-2"></i> Edit Product</button>
                            </div>
                        </div>
                    </div>
